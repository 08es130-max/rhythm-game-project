// Ver.0.8.49: interactive Shioriko-inspired 3D prototype with camera-orbit controls and full-body framing.
(function(){
  'use strict';
  ...
  async function init(slot,message){
    ...
    const orbitTarget=new THREE.Vector3(0,.18,0);
    ...
    message.textContent='3D栞子を読み込みました。正面は頭上・足元に余白を取った全身構図です。ドラッグで360°周回できます。';
