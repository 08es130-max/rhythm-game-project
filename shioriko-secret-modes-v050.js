...
(function(){
  ...
  const lrReward=set([
    ...
    '普段より肌が見えるので、やはり少し恥ずかしいですね。……あまりじっと見つめないでください。',
    'この色、とても綺麗でしょう？　あなたと一緒にいると、いつもより少しだけ華やかに見える気がします。',
    '水着姿でこうしてお迎えするのは、少し緊張します。……でも、あなたになら見ていただきたいと思いました。',
    'その……変ではありませんよね？　あなたが似合っていると思ってくださるなら、それだけで安心できます。',
    '今日はいつもより少し大胆な格好ですから、少しだけ優しく見てくださいね。',
    'こんな姿を見せるのは、やはり照れてしまいます。……ですが、あなたが嬉しそうなら私も嬉しいです。',
    'あなたの前だと、少しくらい素直になってもいいのかなと思ってしまいます。……不思議ですね。',
    '今日は何をしましょうか。ライブでも、お話でも……もう少しだけ、ここで一緒にいるのも素敵ですね。',
    'この水着を選んでよかったです。あなたの隣にいると、少しだけ自信が持てる気がします。',
    'もし似合っていると思ってくださるなら……もう一度、ちゃんと言っていただけますか？',
    'あまり近くで見られると、さすがに恥ずかしいです。……でも、離れてほしいわけではありません。',
    '今日は少しだけ甘えてもよろしいでしょうか。……あなたといると、そうしたくなるのです。',
    'こんなに穏やかな気持ちになれるのは、あなたと一緒だからかもしれませんね。',
    'あなたに見ていただくと思うと、少し頑張ってしまいました。……気づいてくださいましたか？'
  ],[
    'も、もう……そんなに何度も触れられると、さすがに恥ずかしくなってしまいます。',
    'そんなに気になるのですか？　……水着のことなら、感想を聞かせてくださる方が嬉しいです。',
    'あまりからかわないでください。……でも、あなたになら少しくらい許してしまいそうです。',
    '近いです……。その、嫌ではありませんが、心の準備くらいはさせてください。',
    'もう……。そんなに構ってくださるなら、今日は少しだけ甘えてしまいますよ？'
  ],[
    'フルコンボ、お見事です。そんなあなたを見ていると……私まで胸が高鳴ってしまいます。',
    'とても綺麗でした。……ふふ、今日は水着のことより、あなたの方に見惚れてしまいました。'
  ],[
    '新記録、おめでとうございます。こんな瞬間をすぐそばで見られて……私は幸せ者ですね。',
    'また新しい景色を見せてくださいましたね。あなたと一緒にいられる時間が、ますます大切に思えます。'
  ],[
    'Sランクですね。さすがです。……そんなあなたの隣にいられることを、少し誇らしく思います。',
    '本当に素敵でした。今なら私も、この水着姿に少し自信を持てそうです。'
  ],[
    'もう一度ですね。もちろんです。あなたが続けるなら、私も最後までご一緒します。',
    'うまくいかない時もあります。……次はきっと大丈夫です。私がそばにいますから。'
  ]);
