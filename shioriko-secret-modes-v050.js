...
(function(){
  ...
  const lrReward=set([
    '今日は、あなたのためだけにライブをします。……少し緊張しますが、最後まで見ていてくださいね。',
    'この水着、どうでしょうか。……似合っていると、あなたに言っていただけたら嬉しいです。',
    'こうしてあなたと二人で過ごす時間は、私にとってとても大切です。……少しだけ、特別に感じています。',
    '今日は何をしましょうか。ライブでも、お話でも……あなたが望むなら、私は喜んでお付き合いします。',
    'あなたに見ていただくと思うと、いつもより少しだけ頑張ってしまいました。……気づいてくださいましたか？',
    'この姿でお会いするのは、やはり少し照れますね。ですが、あなたならきっと笑わずに見てくださると思っていました。',
    '似合っているでしょうか。……ええ、少し気にしてしまいます。あなたの言葉は、私には思っている以上に大きいので。',
    '今日は、いつもより少しだけ素直でいたい気分です。……あなたの前だから、でしょうか。',
    'あなたの隣にいると、不思議と落ち着きます。だからでしょうか、こういう格好でも少し勇気が出るのです。',
    'ライブが終わっても、もう少しここにいてください。……まだ、あなたとお話ししていたいです。',
    'この景色も綺麗ですが……あなたと一緒に見ている今の方が、私は好きかもしれません。',
    'あなたが楽しそうにしてくださるなら、それで十分です。……いえ、本当は私もとても嬉しいのですが。',
    '今日は、私からお誘いしてもよろしいでしょうか。あなたと一緒に過ごしたいと思ったのです。',
    'あなたに似合っていると言っていただけたら、きっと今日一日、ずっと嬉しいままだと思います。',
    'いつも支えてくださっているあなたに、今日は私から少しでも楽しい時間をお返ししたいです。',
    '無理に言葉にしなくても大丈夫です。あなたがここにいてくださるだけで、私は十分安心できます。',
    'こうして近くでお話ししていると、少し時間を忘れてしまいますね。……もう少しだけ、このままでいませんか？',
    'あなたのために何かできることがあるなら、私は嬉しいです。今日はどうか、遠慮せずに頼ってください。',
    '私らしくないでしょうか。……ふふ、たまにはこういう日があっても、悪くありませんよね。',
    'あなたにだけは、少し格好をつけずにいてもいいのかもしれません。そう思えるようになりました。'
  ],[
    'もう……そんなに何度も呼ばなくても、私はここにいますよ。',
    'そんなに気になるのですか？　……でしたら、きちんと感想を聞かせてください。',
    'あまりからかわないでください。……ですが、あなたになら少しくらい許してしまいそうです。',
    'そんなに構ってくださると、こちらまで嬉しくなってしまいます。……困りましたね。',
    'もう、仕方ありませんね。今日は少しだけ、あなたのわがままにお付き合いします。'
  ],[
    'フルコンボ、お見事です。今日はあなたのためのライブでしたが……気づけば、私の方が励まされていました。',
    '本当に綺麗でした。あなたと同じステージを見られることを、改めて嬉しく思います。'
  ],[
    '新記録、おめでとうございます。あなたがまた一歩進む瞬間を、すぐそばで見届けられて光栄です。',
    '素晴らしいですね。……こうしてあなたの成長を見ていると、私ももっと頑張りたくなります。'
  ],[
    'Sランクですね。さすがです。……そんなあなたの隣にいられることを、少し誇らしく思います。',
    '本当に素敵でした。今日はあなたのために頑張ったつもりでしたが、私の方が嬉しくなってしまいました。'
  ],[
    'もう一度ですね。もちろんです。あなたが望むなら、何度でもご一緒します。',
