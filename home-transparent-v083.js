// Ver.0.8.55 patch loader: version sync, safe areas, interaction room, refined Shioriko 3D, and late-loaded chart fixes.
(function(){
  ...
  loadScript('interaction-room-v0844.js?v=0.8.55-lounge3','interaction-room-v0844',()=>{loadScript('shioriko-model-loader-v0852.js?v=0.8.55-pipeline5','shioriko-model-loader-v0852');});
