...
(function(){
  ...
  if(!document.getElementById('coreScreenSafeAreaV0843')){
    ...
    style.textContent=`
      ...
      #liveScreen>.screen-header{
        box-sizing:border-box!important;
        padding-top:var(--live-select-safe-top)!important;
        padding-left:var(--live-select-safe-left)!important;
        padding-right:var(--live-select-safe-right)!important;
      }
      #liveScreen>#controlsPanel{
        box-sizing:border-box!important;
        margin-left:var(--live-select-safe-left)!important;
        margin-right:var(--live-select-safe-right)!important;
        max-width:calc(100% - var(--live-select-safe-left) - var(--live-select-safe-right))!important;
      }
      #liveScreen .game-wrap{
      ...
      @media (orientation:landscape) and (pointer:coarse){
        ...
        #liveScreen{
          --live-select-safe-left:max(30px,env(safe-area-inset-left));
          --live-select-safe-right:max(30px,env(safe-area-inset-right));
          --live-select-safe-top:max(8px,env(safe-area-inset-top));
        }
      }
      @media (max-width:720px) and (orientation:portrait){
        ...
        #liveScreen{
          --live-select-safe-left:max(14px,env(safe-area-inset-left));
          --live-select-safe-right:max(14px,env(safe-area-inset-right));
        }
      }
    `;
  ...
  loadScript('chart-audio-boundary-v0840.js?v=0.8.43-boundary4','chart-boundary-v0840',()=>{
